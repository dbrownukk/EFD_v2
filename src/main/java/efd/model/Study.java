...
@Views({ @View(members = "Study[#studyName,projectlz,referenceYear;description,startDate,endDate]"
		+ ";warningMessage,"
		+ ";Site{site};StandardOfLivingElement{stdOfLivingElement};DefaultDietItem{defaultDietItem};ExpandabilityRule{expandabilityRule};"
