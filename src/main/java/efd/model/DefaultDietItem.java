...
public class DefaultDietItem extends EFDIdentifiable {
	...
	@Transient
	private double calsNeededofThisDDI;
	
	
	
	
	public double getCalsNeededofThisDDI() {
		return calsNeededofThisDDI;
	}

	public void setCalsNeededofThisDDI(double calsNeededofThisDDI) {
		this.calsNeededofThisDDI = calsNeededofThisDDI;
	}
