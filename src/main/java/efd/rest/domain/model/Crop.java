...
public class Crop extends Asset {
	...
	public Double getUnitsConsumed() {
		Double ret = getUnitsProduced() - getUnitsSold() - getUnitsOtherUse();
		return (ret);
	};
...
//	@DefaultValueCalculator(value = ZeroDoubleCalculator.class)
	...
	public Double getPercentTradeMarket1() {
		return percentTradeMarket1 == null ? 0.0:percentTradeMarket1;
	}
	...
	public Double getPercentTradeMarket2() {
		return percentTradeMarket2 == null ? 0.0:percentTradeMarket2;
	}
	...
	public Double getPercentTradeMarket3() {
		return percentTradeMarket3 == null ? 0.0:percentTradeMarket3;
	}
