...
public class OnChangeAnswerType extends OnChangePropertyBaseAction {
	public void execute() throws Exception {
		...
		if (getNewValue().equals(ConfigQuestion.AnswerType.IntegerRange))
		// get integer range
		...
		else if (getNewValue().equals(ConfigQuestion.AnswerType.DecimalRange)) {
		...
		else if (getNewValue().equals(ConfigQuestion.AnswerType.LOV)) {
		...
		else if (getNewValue().equals(ConfigQuestion.AnswerType.Decimal)
				|| getNewValue().equals(ConfigQuestion.AnswerType.Integer)
				|| getNewValue().equals(ConfigQuestion.AnswerType.Text)) {
