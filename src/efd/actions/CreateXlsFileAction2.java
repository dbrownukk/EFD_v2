...
public class CreateXlsFileAction2 extends CollectionBaseAction implements IForwardAction, JxlsConstants {
	...
	public void execute() throws Exception {
		...
		try {
			...
			HSSFWorkbook scenario = createScenario();
	...
	private HSSFWorkbook createScenario() throws Exception {
		...
		HSSFWorkbook scenarioWB = new HSSFWorkbook(filename);
		...
		JxlsSheet sheet = scenarioWB.addSheet("Data Validation");
