...
public class FoodPurchase extends Asset{
	...
	@DescriptionsList(descriptionProperties="resourcetypename", condition="${resourcetype.resourcetypename} in ('Crops','Wild Foods','Livestock Products','Food Purchase','Food Stocks')")
