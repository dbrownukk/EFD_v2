...
@View(members = "ModellingScenario[#title;author;date;study;project;priceYieldVariations;description]")

@Tab(properties = "title,author,date,priceYieldVariation,study,project")
...
public class ModellingScenario extends EFDIdentifiable {
	...
	@ListProperties("resource,yield,price")
