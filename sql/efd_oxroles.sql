...
INSERT INTO `oxroles` VALUES ('admin','Manages users, roles, folder, modules, organizations, etc.'),('efd_user','All EFD capabilities'),('self sign up','Add to this role the modules available for the self sign up users'),('user','With access to all modules except administration ones');
