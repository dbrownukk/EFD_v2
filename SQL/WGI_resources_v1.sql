CREATE OR REPLACE VIEW WGInterview_details AS
    SELECT 
        ...
        wealthgroupinterview_assetcash.Amount xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_assetfoodstock.Quantity xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_assetland.NumberofUnits xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_assetlivestock.NumberOwnedAtStart xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_assettradeable.NumberOwned xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_assettree.NumberOwned xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_crop.UnitsProduced xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_employment.UnitsWorked xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_foodpurchase.UnitsPurchased xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_nonfoodpurchase.UnitsPurchased xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_livestockproducts.UnitsProduced xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_livestocksales.UnitsSold xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_transfer.UnitsSold xx
    FROM
        project,
        country,
        livelihoodzone,
    ...
    UNION SELECT 
        ...
        wealthgroupinterview_wildfood.UnitsSold xx
    FROM
        project,
        country,
        livelihoodzone,
